...
import React, {useState} from "react"; //useState members users input
...
function App() {
  ...
  const [message, setMessage] = useState(""); //input btn
  const [summary, setSummary] = useState(""); //output summary
  const [sentiment, setSentiment] = useState("");


  //send a message to AI and wait for response
